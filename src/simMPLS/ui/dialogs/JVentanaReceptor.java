...
public class JVentanaReceptor extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        iconoReceptor.setIcon(dispensadorDeImagenes.obtenerIcono(simMPLS.ui.utils.TImagesBroker.RECEPTOR));
        ...
        jLabel1.setText("Configuration of the node");
        panelConfiguration.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 10, -1, -1));

        jLabel2.setText("IP address :");
        panelConfiguration.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 50, -1, -1));
...
private void clicEnCancelar(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_clicEnCancelar
    if (reconfigurando) {
        ...
        configReceptor.setIPAddress(BKUPIP);
...
private void clicEnAceptar(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_clicEnAceptar
    ...
    if(ipAddress.getText().isEmpty()== false || this.reconfigurando){
        configReceptor.setIPAddress(ipAddress.getText());
    }
...
private void ratonEntraEnPanelCoordenadas(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ratonEntraEnPanelCoordenadas
     ...
     * @param recfg TRUE indicates a reconfiguration of the receiving node. FALSE indicates that the node is created.
     */    
